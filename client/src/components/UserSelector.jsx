    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-600 to-blue-600 flex items-center justify-center p-4">
      <div className="max-w-4xl w-full">
        ...
        <div className="text-center mb-12">
          <h1 className="text-5xl font-bold text-white mb-4">🚌 Campus Virtual Bus</h1>
          <p className="text-xl text-purple-100">Choose Your Role</p>
        </div>
          ...
          >
            ...
            >
              ...
              <div className="p-8">
                ...
                <button
                  onClick={() => handleSelect('passenger')}
                  className="w-full mt-6 bg-gradient-to-r from-blue-500 to-blue-600 text-white font-bold py-3 px-6 rounded-lg hover:shadow-lg transition-all"
                >
          ...
          >
            ...
            >
              ...
              <div className="p-8">
                ...
                <button
                  onClick={() => handleSelect('driver')}
                  className="w-full mt-6 bg-gradient-to-r from-orange-500 to-red-600 text-white font-bold py-3 px-6 rounded-lg hover:shadow-lg transition-all"
                >
